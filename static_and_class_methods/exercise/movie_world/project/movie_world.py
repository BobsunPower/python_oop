# from static_and_class_methods.exercise.movie_world.project.customer import Customer
# from static_and_class_methods.exercise.movie_world.project.dvd import DVD
