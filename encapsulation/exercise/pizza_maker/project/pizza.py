# from encapsulation.exercise.pizza_maker.project.dough import Dough
# from encapsulation.exercise.pizza_maker.project.topping import Topping
...
class Pizza:
    def __init__(self, name, dough: Dough, toppings_capacity):
        self.name, self.dough, self.toppings_capacity, self.toppings = name, dough, toppings_capacity, {}
