...
class Zoo:
    def __init__(self, name: str, budget: int, animal_capacity: int, workers_capacity: int):
        self.name, self.__budget, self.animals, self.workers = name, budget, [], []
        self.__animal_capacity, self.__workers_capacity = animal_capacity, workers_capacity
